...
BOT_TOKEN = "7544006967:AAHzhJo9OqVJw3HG_nBGvMctWAf97jD5z_Y"
PAYMENT_CHANNEL = "@zypd2599" #add payment channel here including the '@' sign
OWNER_ID = 1878794912 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@zypd2599"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
